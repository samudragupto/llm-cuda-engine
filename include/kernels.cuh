...
// ==========================================
// PHASE 4: FP16 Kernels + Prefill/Decode
// ==========================================
void k_half_linear(cublasHandle_t handle, half* x, half* W, half* y, int batch_size, int in_features, int out_features);
void k_half_gemv(half* x, half* W, half* y, int in_features, int out_features); // Decode Specialized!
...
void k_half_mha_scores_fused_mask(half* Q, half* K, float* S, int seq, int n_heads, int n_kv_heads, int head_dim);
void k_half_mha_weighted_sum(float* P, half* V, half* O, int seq, int n_heads, int n_kv_heads, int head_dim);
